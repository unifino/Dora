...
buttonsRow2: { label:string, class:string, func: Function }[] = [
    { label: "f137", class: "fas y mini", func: () => { this.adjuster( "B", .3   ) } } ,
    { label: "f137", class: "fas y",      func: () => { this.adjuster( "B", 1.9  ) } } ,
    { label: ""  ,   class: 'space',      func: () => {}                             } ,
    { label: "f138", class: "fas b",      func: () => { this.adjuster( "A", -1.9 ) } } ,
    { label: "f138", class: "fas b mini", func: () => { this.adjuster( "A", -.3  ) } } ,
]
